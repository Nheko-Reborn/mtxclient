...
TEST(Pushrules, ExplicitMentions)
{
    nlohmann::json raw_rule = R"(
{
  "global": {
    "underride": [
      {
    ...
    ctx.user_display_name = "Nico";

    auto simple_explicit = R"({
    "content": {
        "body": "Nico",
        "format": "org.matrix.custom.html",
        "formatted_body": "<a href=\"https://matrix.to/#/%40deepbluev7%3Aneko.dev\">Nico</a>",
        "m.mentions": {
            "user_ids": [
                "@deepbluev7:neko.dev"
            ]
    ...
    "event_id": "$eRdwtw6KD2SRUJL9RyPUP9kkVcK90NqK3S2DbJXltL0",
    "origin_server_ts": 1709919179046,
    "sender": "@test:neko.dev",
    "type": "m.room.message",
    "unsigned": {
        "age": 61
    }
})"_json.get<mtx::events::RoomEvent<mtx::events::msg::Text>>();

    auto simple_explicit_actions = evaluator.evaluate({simple_explicit}, ctx, {});

    std::vector<mtx::pushrules::actions::Action> highlight_actions = {
      mtx::pushrules::actions::notify{},
      mtx::pushrules::actions::set_tweak_highlight{},
      mtx::pushrules::actions::set_tweak_sound{},
    };
    std::vector<mtx::pushrules::actions::Action> highlight_actions2 = {
      mtx::pushrules::actions::notify{},
      mtx::pushrules::actions::set_tweak_sound{},
      mtx::pushrules::actions::set_tweak_highlight{},
    };
    std::vector<mtx::pushrules::actions::Action> no_highlight_actions = {
      mtx::pushrules::actions::notify{},
      mtx::pushrules::actions::set_tweak_sound{},
      mtx::pushrules::actions::set_tweak_highlight{false},
    };

    EXPECT_EQ(simple_explicit_actions, highlight_actions);

    auto simple_explicit_empty = R"({
    "content": {
        "body": "Nico",
        "format": "org.matrix.custom.html",
        "formatted_body": "<a href=\"https://matrix.to/#/%40deepbluev7%3Aneko.dev\">Nico</a>",
    ...
    auto simple_explicit_empty_actions = evaluator.evaluate({simple_explicit_empty}, ctx, {});
    EXPECT_EQ(simple_explicit_empty_actions, no_highlight_actions);
    ...
    auto simple_actions = evaluator.evaluate({simple}, ctx, {});
    EXPECT_EQ(simple_actions, highlight_actions2);
}
